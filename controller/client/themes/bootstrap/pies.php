<div class="container-fluid">
	<div class="row">	    
		...
		<div class="simple-list-grid">
			...
			<?php
			 foreach ($menu as $id => $pmenu){
				 if (($pmenu["type"]=="main") and ($pmenu["page"]=="pies")){				     
					 ?>
					<li class="picca_li">
	   ...
	   <div class="alert alert-danger">
	     ...
	     Выпечка и приготовление пирога, требует большего времени на исполнение заказа. Лучше всего заказывать пироги, не менее чем за 12 часов до требуемого срока.
	 </div>

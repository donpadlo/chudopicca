...
$cfg = new Tconfig;
$cfg->theme="bootstrap";
$cfg->sitename="Чудо Пицца Вологда - Чудная Пицца по отличной цене. Бесплатная доставка пиццы";
$worktime=array();
$worktime[0]=array(10,11,12,13,14,15,16,17,19,20,21,22,23);
$worktime[1]=array(10,11,12,13,14,15,16,17,19,20,21,22,23); 
$worktime[2]=array(10,11,12,13,14,15,16,17,19,20,21,22,23); 
$worktime[3]=array(10,11,12,13,14,15,16,17,19,20,21,22,23); 
$worktime[4]=array(10,11,12,13,14,15,16,17,19,20,21,22,23); 
$worktime[5]=array(10,11,12,13,14,15,16,17,19,20,21,22,23,24); 
$worktime[6]=array(10,11,12,13,14,15,16,17,19,20,21,22,23,24); 
$worktime[7]=array(10,11,12,13,14,15,16,17,19,20,21,22,23); 
switch ($content_page) {
    case "home":
	...
	break;
    case "pies":
	  $content_description="пироги,вкусный пирог,Вологда,бесплатно,пицца,вологда,доставка,чудопицца,быстро,на дом,оплата по безналу,с карточки,удобный выбор блюда, заказ онлайн и доставка еды на дом. Без наценок";
	break;	
    case "about":
...
//состав
  $menu=array();
  $menu[]=["name"=>"По карману",
	   "descr"=>"Экономичная пицца, по карману любому",
	   "type"=>"main", //main or dop
	   "page"=>"home",
	   "structure"=>array("Соус пряный, колбаса п/к, сосиски, перец болгарский, томаты, сыр, зелень"),
	   "weight"=>array("500","800"),
	   "sous"=>array("Барбекью","Кисло-сладкий","Чесночный","Сырный"),      
	   "cost"=>array(330,380),   
	   "images"=>array("pokarmany.png"),
  ];  
  ...
  $menu[]=["name"=>"Сладкоежка",
	   ...
	   "type"=>"main", //main or dop
      "page"=>"home",
	   "structure"=>array("Сироп клубничный, соус сметанный, клубника, персики, груша, киви, ананас, посыпка кондитерская, топинг карамельный"),
	   "weight"=>array("700"),
	   "sous"=>array("Барбекью","Кисло-сладкий","Чесночный","Сырный"),      
	   "cost"=>array(400),    
  ...
  ///ПИРОГИ!
  $menu[]=["name"=>"Пирог с яйцом",
	   "descr"=>"Нежный и сытный пирог с яйцом",
	   "type"=>"main", //main or dop
	    "page"=>"pies",
	   "structure"=>array("Тесто, яйцо, соль"),
	   "weight"=>array("1000"),
	   "sous"=>array(),      
	   "cost"=>array(367),    
	   "images"=>array("nophoto.gif"),
  ];  
  $menu[]=["name"=>"Пирог с капустой",
	   "descr"=>"Нежный и сытный пирог с яйцом и капустой",
	   "type"=>"main", //main or dop
	    "page"=>"pies",
	   "structure"=>array("Тесто, яйцо, капуста, соль"),
	   "weight"=>array("1000"),
	   "sous"=>array(),      
	   "cost"=>array(327),    
	   "images"=>array("nophoto.gif"),
  ];  
  $menu[]=["name"=>"Пирог с луком",
	   "descr"=>"Нежный и сытный пирог с лукой и яйцом",
	   "type"=>"main", //main or dop
	    "page"=>"pies",
	   "structure"=>array("Тесто, яйцо, зеленый лук, соль"),
	   "weight"=>array("1000"),
	   "sous"=>array(),      
	   "cost"=>array(387),    
	   "images"=>array("nophoto.gif"),
  ];  
  $menu[]=["name"=>"Пирог с яблоками",
	   "descr"=>"Нежный и сытный пирог с яйцом",
	   "type"=>"main", //main or dop
	    "page"=>"pies",
	   "structure"=>array("Тесто, яблоки, сахар"),
	   "weight"=>array("1000"),
	   "sous"=>array(),      
	   "cost"=>array(367),    
	   "images"=>array("nophoto.gif"),
  ];  
  $menu[]=["name"=>"Пирог с курой",
	   "descr"=>"Нежный и сытный пирог с курой и шампиньонами",
	   "type"=>"main", //main or dop
	    "page"=>"pies",
	   "structure"=>array("Тесто, курица, шампиньоны, соль"),
	   "weight"=>array("1000"),
	   "sous"=>array(),      
	   "cost"=>array(497),    
	   "images"=>array("nophoto.gif"),
